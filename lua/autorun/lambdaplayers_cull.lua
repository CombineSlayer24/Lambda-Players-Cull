...
-- Why have Lambda Players far from the player, outside their PVS
...
--CreateLambdaConvar( "lambdaplayers_cull_enable", "1", true, false, false, "Lambda Players will be removed if far from players.", 0, 1, { type = "Bool", name = "Cull Lambda Players", category = "Pyri's Lambda Collection" } )
--CreateLambdaConvar( "lambdaplayers_cull_distance", "2000", true, false, false, "If Lambda Players are beyond the distance between them and a player, will be removed.\n\n1600-2000, 2400-3000 recommended.", 400, 10000, { type = "Slider", decimals = 0, name = "Cull Lambda Players", category = "Pyri's Lambda Collection" } )
...
local function RemoveFarLambda()
	...
	for _, ent in pairs( ents_GetAll() ) do
...
timer_Create( "RemoveFarLambdaTimer", 5, 0, RemoveFarLambda )
